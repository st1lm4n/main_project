...
@pytest.fixture
def number_card():
    return ["MasterCard 7158300734726758", "Счет 8970605943211234567"]


@pytest.mark.parametrize("number_card, expected", [("MasterCard 7158300734726758", "MasterCard 7158 30** **** 6758"),
                                                   ("Счет 89701605943211234567", "Счет **4567")])
